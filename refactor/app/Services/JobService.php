...
class JobService
{
    ...
    public function __construct(User $userModel, Job $jobModel)
    {
    ...
    public function getUsersJobs($user_id)
    {
        ...
        if ($cuser) {
            if ($cuser->is('customer')) {
                ...
                $jobs = $this->jobModel->getTranslatorJobs($cuser->id, 'new');
            ...
            $normalJobs = collect($normalJobs)->each(function ($item, $key) use ($user_id) {
                $item['usercheck'] = $this->jobModel->checkParticularJob($user_id, $item);
            })->sortBy('due')->all();
        }
