...
class JObRepository extends BaseRepository
{
    ...
    public function getUsersJobsHistory($user_id, Request $request)
    {
        ...
        if ($cuser && $cuser->is('customer')) {
            ...
            return $this->formatJobsResponse([], [], $jobs, $cuser, $usertype);
            ...
            return $this->formatJobsResponse([], $normalJobs, $jobs, $cuser, $usertype, $numpages, $pagenum);
        }
    }
     ...
     * @return array
     */
    private function formatJobsResponse($emergencyJobs, $normalJobs, $jobs, $cuser, $usertype, $numpages = 0, $pagenum = 0)
    {
        return [
